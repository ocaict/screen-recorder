...
- [x] **Cursor Customization**: Provide options to show/hide the cursor and apply custom cursor effects.
...
- [x] **Custom watermarks**: Add text/image watermark capabilities to recordings.
...
- [x] **Error Recovery**: Implement better handling when sources are disconnected mid-recording (added WebM backup fallback).
...
- [x] **Memory Optimization**: Stream processing to disk instead of using RAM for long recordings.
